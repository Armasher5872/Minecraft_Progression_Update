...
public enum ModArmorMaterials implements ArmorMaterial {
    FIRESTONE("firestone", 30, new int[]{ 2, 6, 5, 2 }, 15,
            SoundEvents.ARMOR_EQUIP_IRON, 3f, 0.3f, () -> Ingredient.of(ModItems.FIRESTONE_SHARDS.get()));
    ...
    public String getName() {
        return minecraft_progression_update.MOD_ID + ":" + this.name;
    }
    @Override
